...
args = {
    "project_id": "hello-generic-world-0404134431",
}

dag = DAG(
    "hello-generic-world-0404134431",
    default_args=args,
...
op_bb889c69_b23a_484e_8fb3_e69309f38a98 = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "hello-generic-world-0404134431-{{ ts_nodash }}",
    },
    in_cluster=True,
    config_file="None",
    dag=dag,
